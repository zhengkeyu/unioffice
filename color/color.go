...
import (
	_g "fmt"
	_d "gitee.com/greatmusicians/unioffice"
)
...
func (_fg Color) IsAuto() bool { return _fg._b }
...
func FromHex(s string) Color {
	...
	var _fd, _be, _ee uint8
	_fe, _ := _g.Sscanf(s, "\u002502x\u002502x\u002502x", &_fd, &_be, &_ee)
	if _fe == 3 {
		return RGB(_fd, _be, _ee)
	}
	return Auto
}
...
func (_bc Color) AsRGBString() *string {
	return _d.Stringf("\u002502x\u002502x\u002502x", _bc._a, _bc._f, _bc._de)
}
...
// to a string containing a six digit hex RGB value.
func (_c Color) AsRGBAString() *string {
	return _d.Stringf("\u002502x\u002502x\u002502x\u002502x", _c._ga, _c._a, _c._f, _c._de)
}
